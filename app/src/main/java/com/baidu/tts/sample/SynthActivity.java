...
import com.baidu.tts.sample.control.MyRecognizer;
...
import com.baidu.tts.sample.recognization.IRecogListener;
import com.baidu.tts.sample.recognization.StatusRecogListener;
import com.baidu.tts.sample.recognization.TtsRecogListener;
...
public class SynthActivity extends BaseActivity implements View.OnClickListener {
     ...
     */
    protected String appId = "10455099";

    protected String appKey = "rKCHBLmYiFPuCQTS0HttLbUD";

    protected String secretKey = "037dc446820ec143d1628c20146b9d34";
    ...
    private void startAsr(){
        ...
        toPrint("请开始说话");
        Toast.makeText(this, "请开始说话", Toast.LENGTH_LONG);
    }
    /**
     * 界面上的按钮对应方法
     */
